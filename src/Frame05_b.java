...
public class Frame05_b extends JFrame implements ActionListener
{
    ...
    JTextArea textArea;
    LinkedList<Block_02> blockList =new LinkedList<Block_02>();
    public Frame05_b()
    {
        setTitle("最佳适应算法");
    ...
    public boolean allocation(int id, int size)//分配
    {
        ...
        if(flag)
        {
            ...
            {
                Block_02 newBlock = new Block_02();
                newBlock.id = -1;
    ...
    public void show(LinkedList<Block_02> blockList)
    {
